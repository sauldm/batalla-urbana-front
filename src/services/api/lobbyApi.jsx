...
export async function createLobbyHttp() {
    const res = await fetch("https://batallaurbana.com/api/lobbies", {
        method: "POST",
    });
...
export async function joinLobbyHttp( id, nickName ) {
    const res = await fetch("https://batallaurbana.com/api/joinLobby", {
        method: "POST",
        headers: {
...
export async function createGameHttp(id, players) {
    const res = await fetch("https://batallaurbana.com/api/createGame", {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
